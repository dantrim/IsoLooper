...
//
// IsoTester 
// Executable auto-generated with SusyNtuple/make_susy_skeleton on 2017-07-05 11:48
//
//
//////////////////////////////////////////////////////
...
void help()
{
    ...
    cout << "   -x          resonance mass input (int)" << endl;
    cout << "   -h          print this help message" << endl;
    cout << endl;
    cout << "  Example Usage:" << endl;
    cout << "   IsoTester -i susyNt.root -n 500" << endl;
    cout << "----------------------------------------------------------" << endl;
}
...
int main(int argc, char** argv)
{
    ...
    for(int i = 1; i < argc; i++) {
        ...
        else if (strcmp(argv[i], "-x") == 0) res_mass = atoi(argv[++i]);
        else if (strcmp(argv[i], "-h") == 0) { help(); return 0; }
        else {
            cout << "IsoTester    Unknown command line argument '" << argv[i] << "', exiting" << endl;
            help();
            return 1;
        }
    } // i
    ...
    if(input.empty()) {
        cout << "IsoTester    You must specify an input" << endl;
        return 1;
    }
    ...
    /////////////////////////////////////////////////////////
    IsoLooper* analysis = new IsoLooper();
    ...
    cout << endl;
    cout << "IsoTester    Analysis loop done" << endl;
